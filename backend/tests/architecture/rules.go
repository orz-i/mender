...
var processes = map[string]bool{"process:admission": true, "process:settlement": true, "process:mcpbridge": true, "process:consolelaunch": true, "process:catalogmanagement": true}
