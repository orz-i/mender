...
func ConnectionManagerRole(ctx context.Context, pool *pgxpool.Pool) error {
	...
	err := pool.QueryRow(ctx, `SELECT has_column_privilege(current_user,'connections.connections','workspace_id','SELECT')
	 ...
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','workspace_id','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','connection_id','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','provider_id','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','refresh_credential_ref','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','refresh_secret_revision','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','connection_revision','INSERT')
	 AND NOT has_column_privilege(current_user,'connections.oauth_refresh_sessions','connection_revision','UPDATE')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','required_scopes','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','granted_scopes','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','state','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','last_error_code','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','created_at','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','updated_at','INSERT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','last_refreshed_at','INSERT')
	 AND NOT has_table_privilege(current_user,'connections.oauth_refresh_sessions','SELECT,UPDATE,DELETE,TRUNCATE')
	 AND has_function_privilege(current_user,'connections.revoke_oauth_refresh_session(text,text,bigint,bigint,timestamptz)','EXECUTE')
