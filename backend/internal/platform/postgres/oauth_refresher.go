...
func OAuthRefresherRole(ctx context.Context, pool *pgxpool.Pool) error {
	...
	err := pool.QueryRow(ctx, `SELECT
	 ...
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','workspace_id','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','connection_id','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','provider_id','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','refresh_credential_ref','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','refresh_secret_revision','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','connection_revision','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','required_scopes','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','granted_scopes','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','state','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','last_error_code','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','created_at','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','updated_at','SELECT')
	 AND has_column_privilege(current_user,'connections.oauth_refresh_sessions','last_refreshed_at','SELECT')
