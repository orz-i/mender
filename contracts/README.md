...
| [usage-observability.openapi.yaml](usage-observability.openapi.yaml) | Human Console 只读 quota observability：Budget period 与最近 reservation/settlement 安全投影，micro 金额使用十进制字符串；不是支付账本或 billing admin |
