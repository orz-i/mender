...
| [usage-observability.openapi.yaml](usage-observability.openapi.yaml) | v0.2.0：Human Console 只读 quota observability + Run delegation 单 Run quota cost；micro 金额使用十进制字符串，不是支付账本或 billing admin |
