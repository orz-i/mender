...
| [fixed-toolset-contract.json](fixed-toolset-contract.json) | Fixed Toolset MCP 的 Catalog ToolVersion／Toolset Binding 发布合同；当前仅定义不可变 Schema、稳定别名与固定 Connection，不代表 direct tools 已完成 |
